...
const I18N = {
  de: {
    ...
    "auth.accessCodeLabel": "Passwort",
    "auth.accessCodePlaceholder": "Passwort eingeben",
    ...
    "auth.purchaseKicker": "Noch kein Konto?",
    "auth.purchaseBody":
      "Pro-Zugang fur €4.99 pro Monat — sicher per Stripe. Danach mit Email und Passwort einloggen.",
    "auth.purchaseCta": "Zugang kaufen — €4.99 / Monat",
    "auth.purchaseCtaAria": "Zur Kaufseite fur Pro-Zugang",
  ...
  en: {
    ...
    "auth.accessCodeLabel": "Password",
    "auth.accessCodePlaceholder": "Enter password",
    "auth.enterDashboard": "Enter Dashboard",
    "auth.viewSignals": "Signals",
    "auth.hint": "Private system. Access for authorized users only.",
    "auth.purchaseKicker": "Need an account?",
    "auth.purchaseBody":
      "Unlock Pro for €4.99/month via Stripe. Then sign in here with your email and password.",
    "auth.purchaseCta": "Buy access — €4.99 / month",
    "auth.purchaseCtaAria": "Open checkout page for Pro access",
